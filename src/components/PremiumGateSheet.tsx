...
export function PremiumGateSheet({ icon, title, desc, onUpgrade, onClose }: {
  ...
  return (
    <div style={{ position:"fixed",inset:0,zIndex:500,background:C.overlay,backdropFilter:"blur(22px)",display:"flex",alignItems:"flex-end",justifyContent:"center" }} onClick={onClose}>
